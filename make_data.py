...
print 'Note, check system status to see if processing is occuring, there will be no progress written to terminal for a while...'
# Set range below to be equal to the number of lakes in the lake file to process
